...
public class Gui extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// Eventhandler zum Beenden des Threads beim Schlie�en der GUI
	...
	/**
	 * Sendet die aktuellen Daten und Einstellungen f�r ein Modul an das WSN
	 * 
	 * @param Raum
	 *            der Raum f�r den das Modul mit allen Einstellungen im WSN
	...
	public static void updateModule(Raum raum) {
		...
		if (raum.getModul() != null) {
			...
			if (raum.getLicht() != null) {
				...
				// LichtZiel von 0-3 in 0-255 �bersetzen
			...
			// Format f�r die ZielTemperatur festlegen
